...
if __name__=="__main__":
    ...
    save_path="./logs/",
    name_prefix=datetime.now().strftime('philip4_tqc_deep_movingreach_joints_%H_%M_%d'),
    ...
    tmp_path = "./tmp/"+datetime.now().strftime('tqc_dual_philip4_movingreach_joints_%H_%M_%d')
