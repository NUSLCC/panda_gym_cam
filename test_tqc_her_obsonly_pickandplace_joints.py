...
if __name__=="__main__":
    ...
    env_id = "PandaPickandPlaceCamDenseJoints-v3"
    num_cpu = 16
    ...
    save_path="./logs/",
    name_prefix=datetime.now().strftime('philip4_tqc_deep_obsonly_pickandplace_joints_%H_%M_%d'),
    ...
    tmp_path = "./tmp/"+datetime.now().strftime('tqc_dual_philip4_obsonly_pickandplace_joints_%H_%M_%d')
