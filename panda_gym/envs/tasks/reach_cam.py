...
class ReachCam(Task):
    ...
    def render_from_stationary_cam(
        ...
        """
        cam_pos = self.sim.get_link_position("stationary_camera", self.staionary_cam_link)
        cam_orn = self.sim.get_link_orientation("stationary_camera", self.staionary_cam_link)
