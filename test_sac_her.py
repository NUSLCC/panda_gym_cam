...
if __name__=="__main__":
    ...
    model = SAC(policy="MultiInputPolicy",env=env, batch_size=4, gamma=0.95, learning_rate=1e-4, verbose=1, 
                train_freq=64, gradient_steps=64, tau=0.05, tensorboard_log="./tmp", learning_starts=2000,
                buffer_size=300000, replay_buffer_class=HerReplayBuffer, device="cuda:0",
                # Parameters for HER
