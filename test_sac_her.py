...
if __name__=="__main__":
    ...
    model = SAC(policy="MultiInputPolicy",env=env, batch_size=2048, gamma=0.95, learning_rate=1e-4, verbose=1, 
                ...
                buffer_size=30000, replay_buffer_class=HerReplayBuffer, device="cuda:1",
                # Parameters for HER
    ...
    # print(model.policy)
    tmp_path = "./tmp/"+datetime.now().strftime('sac_dual_cnn_moving_new_%H_%M_%d')
    # set up logger
    ...
    model.save("sac_her_dual_cnn_moving_new")
