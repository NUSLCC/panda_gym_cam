...
if __name__=="__main__":
    ...
    # model = TQC.load("logs/philip4_tqc_deep_pickandplace_07_36_05_700000_steps", env = env)
    # model.load_replay_buffer("logs/philip4_tqc_deep_pickandplace_07_36_05_replay_buffer_700000_steps", truncate_last_traj=False)
    # print(f'Replay buffer size is {model.replay_buffer.size()}')
    # tmp_path = "./tmp/"+"tqc_dual_philip4_pickandplace_10_06_04"
    # new_logger = configure(tmp_path, ["stdout", "csv", "tensorboard"])
    # model.set_logger(new_logger)
