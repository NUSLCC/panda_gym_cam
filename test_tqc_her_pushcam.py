...
if __name__=="__main__":
    ...
    save_path="./logs/",
    name_prefix="philip4_tqc_deep_push_joints",
    ...
    tmp_path = "./tmp/"+datetime.now().strftime('tqc_dual_philip4_push_joints_%H_%M_%d')
    ...
    # model = TQC.load("logs/philip4_tqc_deep_push__joints_100000_steps", env = env)
    # model.load_replay_buffer("logs/philip4_tqc_deep_push_joints_replay_buffer_100000_steps", truncate_last_traj=False)
